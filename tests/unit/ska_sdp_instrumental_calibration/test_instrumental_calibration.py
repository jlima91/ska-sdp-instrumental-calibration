...
from ska_sdp_instrumental_calibration.instrumental_calibration import (  # noqa: E501
    experimental,
)
...
@patch("ska_sdp_instrumental_calibration.instrumental_calibration.read_yml")
@patch("ska_sdp_instrumental_calibration.instrumental_calibration.write_yml")
@patch(
    "ska_sdp_instrumental_calibration.instrumental_calibration.tempfile."
    "mkstemp"
)
@patch("ska_sdp_instrumental_calibration.instrumental_calibration.Stages")
@patch(
    "ska_sdp_instrumental_calibration.instrumental_calibration.copy.deepcopy"
)
...
@patch("ska_sdp_instrumental_calibration.instrumental_calibration.logger")
@patch("ska_sdp_instrumental_calibration.instrumental_calibration.read_yml")
@patch("ska_sdp_instrumental_calibration.instrumental_calibration.Stages")
